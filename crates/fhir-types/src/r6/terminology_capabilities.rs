    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "supplement" => raw_supplement = Some(value),
                "_supplement" => raw_supplement_element = Some(value),
                "versionAlgorithmString" => {
                    raw_version_algorithm.value("String", value, path)?;
                }
                "_versionAlgorithmString" => {
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "url" => raw_url = Some(value),
                "_url" => raw_url_element = Some(value),
                "fragmentSupport" => raw_fragment_support = Some(value),
                "_fragmentSupport" => raw_fragment_support_element = Some(value),
                "supplementSupport" => raw_supplement_support = Some(value),
                "_supplementSupport" => raw_supplement_support_element = Some(value),
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
                    });
    ...
    fn from_json(
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "extension" => raw_extension = Some(value),
                "modifierExtension" => raw_modifier_extension = Some(value),
                "globals" => raw_globals = Some(value),
                "_globals" => raw_globals_element = Some(value),
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
                    });
