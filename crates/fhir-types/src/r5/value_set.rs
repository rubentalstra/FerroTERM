...
impl super::super::codec::Json for ValueSetComposeIncludeConceptDesignation {
    ...
    fn from_json(
        ...
        let mut raw_additional_use: Option<&serde_json::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "additionalUse" => raw_additional_use = Some(value),
...
impl super::super::codec::Json for ValueSetExpansion {
    ...
    fn from_json(
        ...
        let mut raw_next: Option<&serde_json::Value> = None;
        let mut raw_next_element: Option<&serde_json::Value> = None;
        ...
        for (key, value) in object {
            match key.as_str() {
                ...
                "next" => raw_next = Some(value),
                "_next" => raw_next_element = Some(value),
...
impl super::super::codec::Json for ValueSetExpansionContainsProperty {
    ...
    fn from_json(
        ...
        let mut raw_sub_property: Option<&serde_json::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => raw_id = Some(value),
                "extension" => raw_extension = Some(value),
                ...
                "subProperty" => raw_sub_property = Some(value),
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
                    });
...
impl super::super::codec::Json for ValueSetScope {
    ...
    fn from_json(
        ...
        let mut raw_extension: Option<&serde_json::Value> = None;
        let mut raw_modifier_extension: Option<&serde_json::Value> = None;
        let mut raw_inclusion_criteria: Option<&serde_json::Value> = None;
        let mut raw_inclusion_criteria_element: Option<&serde_json::Value> = None;
        let mut raw_exclusion_criteria: Option<&serde_json::Value> = None;
        let mut raw_exclusion_criteria_element: Option<&serde_json::Value> = None;
        for (key, value) in object {
            match key.as_str() {
                "id" => raw_id = Some(value),
                "extension" => raw_extension = Some(value),
                "modifierExtension" => raw_modifier_extension = Some(value),
                "inclusionCriteria" => raw_inclusion_criteria = Some(value),
                "_inclusionCriteria" => raw_inclusion_criteria_element = Some(value),
                "exclusionCriteria" => raw_exclusion_criteria = Some(value),
                "_exclusionCriteria" => raw_exclusion_criteria_element = Some(value),
                other => {
                    return path.with(other, |path| {
                        Err(path.error(super::super::codec::DecodeErrorKind::UnknownProperty))
                    });
