...
use ferroterm_graph::attributes::{Row, ValueRef};
use ferroterm_graph::ordinal::Ordinal;
use ferroterm_graph::refsets::{Table, ValueRef as FieldRef};
...
pub trait Model {
    ...
    fn attributes(&self) -> &ferroterm_graph::attributes::Attributes;
    /// The reference set member tables.
    fn members(&self) -> &ferroterm_graph::refsets::RefsetMembers;
    /// The alternate identifiers.
    fn identifiers(&self) -> &ferroterm_graph::identifiers::Identifiers;
            ...
            Some(RefsetFields::Any) => {
                ...
                columns.extend(
                    table
                        ...
                        .enumerate()
                        .filter(|(_, kind)| {
                            **kind == ferroterm_graph::refsets::FieldKind::Component
                        })
                        .map(|(i, _)| Some(i)),
                );
                columns
