...
- Consume the generated `ferroterm-fhir` types directly; never re-model FHIR here.
  A missing shape is a `ferroterm-fhir-codegen` fix (`.claude/rules/codegen.md`).
