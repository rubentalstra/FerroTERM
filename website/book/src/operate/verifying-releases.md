...
```console
$ gh attestation verify ferroterm-v0.1.3-x86_64-unknown-linux-musl.tar.gz \
    -R rubentalstra/FerroTERM \
    --signer-workflow rubentalstra/FerroTERM/.github/workflows/release-build.yml
$ gh attestation verify oci://ghcr.io/rubentalstra/ferroterm:0.1.3 \
    -R rubentalstra/FerroTERM \
...
```console
$ sha256sum -c ferroterm-v0.1.3-x86_64-unknown-linux-musl.tar.gz.sha256sum
```
