...
$ docker run --rm -p 8080:8080 \
    ...
    ghcr.io/rubentalstra/ferroterm:0.0.10
```
...
```console
$ gh release download v0.0.10 -R rubentalstra/FerroTERM -p 'ferroterm-v0.0.10-x86_64-unknown-linux-musl.tar.gz*'
$ gh attestation verify ferroterm-v0.0.10-x86_64-unknown-linux-musl.tar.gz -R rubentalstra/FerroTERM \
    --signer-workflow rubentalstra/FerroTERM/.github/workflows/release-build.yml
$ tar xzf ferroterm-v0.0.10-x86_64-unknown-linux-musl.tar.gz
