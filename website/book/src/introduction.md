...
server answers FHIR R4 under `/r4` and R4B under `/r4b`; the CI lane runs the
HL7 terminology ecosystem suite against both on every change and holds a
committed pass list per version.
