...
> FerroTERM's own figures are measurements of v0.0.6 over the licensed Dutch
...
| FerroTERM 0.0.6 | Rust | `redb`, memory-mapped | 591 MB on disk, 420 to 580 MB resident with two more systems loaded | one static binary or a distroless image |
