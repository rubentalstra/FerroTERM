...
`omop` rows were last measured on 2026-09-06.

| mode | surface | pass list | passed of ran | needs | open failures |
|---|---|---|---|---|---|
| `general` | `/r4b` | `passing.txt` | 616 of 670 | nothing | #353 |
| `general` | `/r4` | `passing-r4.txt` | 623 of 670 | nothing | #353 |
| `general` | `/r5` | `passing-r5.txt` | 625 of 670 | nothing | #353 |
