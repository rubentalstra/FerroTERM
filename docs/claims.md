...
| `ghcr.io/rubentalstra/ferroterm:0.1.0` is the current image tag | `Cargo.toml` `version = "0.1.0"`, `compose.yaml:36`; enforced by `scripts/checks/versions.sh` and by the tag check in `.github/workflows/release.yml` job `plan` |
...
| Warm p50 over 200 HTTP round trips, Apple M2, 17.18 GB, macos/aarch64, FerroTERM 0.1.0, FHIR R4B, 2026-09-05 | The record `machine` and `latency[].warm_requests` fields; the footer is generated by `scripts/checks/bench-table.jq:32-36`, never typed |
