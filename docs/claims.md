...
| The per-system figures (concepts, build, peak build memory, index on disk, resident, per-operation warm p50) | `bench/records/2026-09-06-apple-m2/*.json`, one record per row, rendered by `scripts/checks/bench-table.sh` |
...
record set is `bench/records/2026-09-06-apple-m2/`, and every record in it
