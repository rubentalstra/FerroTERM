...
| `ghcr.io/rubentalstra/ferroterm:0.1.1` is the current image tag | `Cargo.toml` `version = "0.1.1"`, `compose.yaml:36`; enforced by `scripts/checks/versions.sh` and by the tag check in `.github/workflows/release.yml` job `plan` |
