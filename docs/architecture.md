...
| `crates/syndication` | The Atom terminology syndication client: the feed model and its NCTS extensions, entry selection, checksum-verified download, and the `Source` seam each service add-on implements | hand-written |
