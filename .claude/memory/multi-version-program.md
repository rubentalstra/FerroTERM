...
State on 2026-09-03 (night): v0.0.8 (ECL) is tagged. #146 (neutral core), #113 (R4, PR #152), the R5 surface (PR #153, part of #114), and #155 (lookup `property=*`, display designation, `name`; PR #156) are merged; #158 (R5 answers `definition` once) and #157 (the Sonar project key after the rename) are open with auto-merge. `/r5` passes 123 of 670, `/r4b` and `/r4` 120. #114 stays open on its pass-count criterion.
