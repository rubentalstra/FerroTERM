---
paths: ["scripts/vendor/*.sh", "tools/notio-fhir-codegen/vendor/**", "crates/**/tests/fixtures/**"]
---
...
- **Fetched by a committed `scripts/vendor/*.sh` script.** Never hand-download
  ...
  commit the result.
- **Vendored verbatim** under `tools/notio-fhir-codegen/vendor/<package>/`,
...
| `hl7.fhir.r5.core` 5.0.0 | `scripts/vendor/fhir-packages.sh` | `tools/notio-fhir-codegen/vendor/hl7.fhir.r5.core/` |
| `hl7.fhir.r6.core` 6.0.0-ballot | `scripts/vendor/fhir-packages.sh` | `tools/notio-fhir-codegen/vendor/hl7.fhir.r6.core/` |
| `hl7.terminology` (THO) | `scripts/vendor/fhir-packages.sh` | `tools/notio-fhir-codegen/vendor/hl7.terminology/` |
